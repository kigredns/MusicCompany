...
function notif:Notification(title, desc, font, font2, visibletime)
    pcall(function()
        ...
        -- Tworzymy napis "Demonic" z metalicznym gradientem i animacją fal
        ...
        demonicLabel.TextColor3 = Color3.fromRGB(255, 0, 0) -- podstawowy czerwony
        ...
        -- Napis "Songs" bez gradientu, biały
        ...
        -- Skrypty obsługujące zamknięcie powiadomienia i animację wejścia
        function Code_LocalScript_1() --LocalScript (przycisk X)
